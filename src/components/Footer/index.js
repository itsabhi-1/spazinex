          ...
          <div className="col-lg-4 order-4 order-lg-0">
            <div className="widget-item">
              <div className="about-widget">
                ...
                <Text>
                  Empowering Businesses with Transformative Solutions. Driving
                  Growth and Success in Today's Competitive Landscape
                </Text>

                <Text classes="copyright-txt">
                  &copy; {new Date().getFullYear()} Spazinex Ltd. All Rights
                  Reserved.
                </Text>
              </div>
            </div>
          ...
          <div className="col-md-4 col-lg-2 ml-auto">
            <Widget title="Social Links">
              <List classes="widget-list">
                ...
                <LI>
                  <Link to="https://twitter.com/hasthemes/" target={"_blank"}>
                    Twitter
                  </Link>
                </LI>
